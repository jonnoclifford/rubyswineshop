...
export function AnimatedLogo({ showHeading = false }: AnimatedLogoProps) {
  ...
  return (
    <div className="relative w-full max-w-2xl mx-auto h-[420px] xl:h-[650px] -mt-12 xl:mt-0">
      ...
      <div
        className={`absolute left-0 right-0 -top-3 xl:-top-[20px] transition-all ease-out ${
          startAnimation
      ...
      {showHeading && (
        ...
        >
          <h1 className="font-serif text-heading-lg text-navy text-center px-6 tracking-normal">
