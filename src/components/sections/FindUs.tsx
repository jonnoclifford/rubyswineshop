  ...
  return (
    <section id="find-us" className="py-section-lg bg-cream">
      <div className="container mx-auto px-6 lg:px-8">
        <AnimatedSection>
          <h2 className="font-serif font-bold tracking-wide text-display-md text-navy mb-12 text-center">
            {findUs.heading}
          </h2>
        </AnimatedSection>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <AnimatedSection variants={slideInRight}>
            <div>
              <h3 className="font-serif font-bold tracking-wide text-heading-lg text-navy mb-6">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-serif font-bold tracking-wide text-heading-sm text-navy mb-1">
                      Address
                    </h4>
                ...
                <div className="pt-6 border-t border-navy/10">
                  <h4 className="font-serif font-bold tracking-wide text-heading-sm text-navy mb-4">
                    Opening Hours
                  </h4>
