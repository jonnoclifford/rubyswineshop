  ...
  return (
    <section id="menu" className="py-section-lg bg-cream">
      <div className="container mx-auto px-6 lg:px-8">
        ...
        <div className="mb-16">
          <AnimatedSection>
            <h3 className="font-serif font-bold text-heading-lg text-terracotta mb-8 tracking-normal">
          ...
          <div className="space-y-12">
            {menu.byTheBottle.categories.map((category, categoryIndex) => (
              <div key={categoryIndex}>
                <h4 className="font-serif font-bold text-heading-md text-navy mb-6 tracking-normal">
                  {category.name}
                </h4>
                <motion.div
                  variants={staggerContainer}
